...
namespace EFCTest01.Lib.Models
{
    public static class Testdaten_EFC01
    {

        public static void TestdatenGenerierung_Niederlassung(ModelBuilder modelBuilder)
        {
        ...
        public static void TestdatenGenerierung_Mitarbeiter(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Mitarbeiter>().HasData(
                new Mitarbeiter { MitarbeiterId = 1, Prsnr = "1001", Nachname = "Paul", Vorname = "Gabriele", Geschlecht = "w", DatumEintritt = new DateOnly(2006, 01, 01), Extern = false, Email = "gpaul@projektdb.de", Durchwahl = "20", AbteilungId = 1, FunktionId = 5, NiederlassungId = 3, Geburtsdatum = new DateOnly(1993, 08, 23) },
                new Mitarbeiter { MitarbeiterId = 2, Prsnr = "1002", Nachname = "Unterlauf", Vorname = "Karin", Geschlecht = "w", DatumEintritt = new DateOnly(2012, 05, 15), Extern = false, Email = "kunterlauf@projektdb.de", Durchwahl = "22", AbteilungId = 1, FunktionId = 6,  NiederlassungId = 3, Geburtsdatum = new DateOnly(1970, 02, 06) },
                new Mitarbeiter { MitarbeiterId = 3, Prsnr = "1003", Nachname = "Schiefner", Vorname = "Emi", Geschlecht = "w", DatumEintritt = new DateOnly(2010, 10, 01), Extern = false, Email = "eschiefner@projektdb.de", Durchwahl = "21", AbteilungId = 1, FunktionId = 6, NiederlassungId = 3, Geburtsdatum = new DateOnly(1980, 05, 14) },
                new Mitarbeiter { MitarbeiterId = 4, Prsnr = "1004", Nachname = "Geist", Vorname = "Ottmar", Geschlecht = "m", DatumEintritt = new DateOnly(2010, 10, 15), Extern = false, Email = "ogeist@projektdb.de", Durchwahl = "4567", AbteilungId = 2, FunktionId = 6, NiederlassungId = 2, Geburtsdatum = new DateOnly(1979, 05, 13) },
                new Mitarbeiter { MitarbeiterId = 5, Prsnr = "1005", Nachname = "Wendisch", Vorname = "Horst", Geschlecht = "m", DatumEintritt = new DateOnly(2006, 01, 02), Extern = false, Email = "hwendisch@projektdb.de", Durchwahl = "123", AbteilungId = 2, FunktionId = 6, NiederlassungId = 1, Geburtsdatum = new DateOnly(1981, 05, 14) },
                new Mitarbeiter { MitarbeiterId = 6, Prsnr = "1006", Nachname = "Koritz", Vorname = "Gundula", Geschlecht = "w", DatumEintritt = new DateOnly(2006, 01, 03), Extern = false, Email = "gkoritz@projektdb.de", Durchwahl = "13", AbteilungId = 2, FunktionId = 5, NiederlassungId = 3, Geburtsdatum = new DateOnly(1985, 06, 16) },
                new Mitarbeiter { MitarbeiterId = 7, Prsnr = "1007", Nachname = "Lorenz", Vorname = "Kathrin", Geschlecht = "w", DatumEintritt = new DateOnly(2006, 01, 17), Extern = false, Email = "klorenz@projektdb.de", Durchwahl = "35", AbteilungId = 3, FunktionId = 2, NiederlassungId = 3, Geburtsdatum = new DateOnly(1998, 10, 26) },
                new Mitarbeiter { MitarbeiterId = 8, Prsnr = "1008", Nachname = "Mühle", Vorname = "Andreas", Geschlecht = "m", DatumEintritt = new DateOnly(2006, 01, 18), Extern = false, Email = "amuehle@projektdb.de", Durchwahl = "36", AbteilungId = 3, FunktionId = 6, NiederlassungId = 3, Geburtsdatum = new DateOnly(1971, 03, 08) },
                new Mitarbeiter { MitarbeiterId = 9, Prsnr = "1009", Nachname = "Arendt", Vorname = "Sibylle", Geschlecht = "w", DatumEintritt = new DateOnly(2006, 01, 01), Extern = false, Email = "sarendt@projektdb.de", Durchwahl = "234", AbteilungId = 4, FunktionId = 2, NiederlassungId = 1, Geburtsdatum = new DateOnly(1986, 07, 18) },
                new Mitarbeiter { MitarbeiterId = 10, Prsnr = "1010", Nachname = "Heinrich", Vorname = "Otto", Geschlecht = "m", DatumEintritt = new DateOnly(2020, 01, 01), Extern = false, Email = "oheinrich@projektdb.de", Durchwahl = "30", AbteilungId = 4, FunktionId = 6, NiederlassungId = 4, Geburtsdatum = new DateOnly(1979, 05, 13) },
        ...
        //{
        //    modelBuilder.Entity<Mitarbeiter>().HasData(
        //        new Mitarbeiter { MitarbeiterId = 1, Prsnr = "1001", Nachname = "Paul", Vorname = "Gabriele", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2006, 01, 01), Extern = true, Email = "gpaul@projektdb.de", Durchwahl = "20", AbteilungId = 1, FunktionId = 5, NiederlassungId = 3, Geburtsdatum = new DateOnly(1993, 08, 23) },
        //        new Mitarbeiter { MitarbeiterId = 2, Prsnr = "1002", Nachname = "Unterlauf", Vorname = "Karin", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2012, 05, 15), Extern = true, Email = "kunterlauf@projektdb.de", Durchwahl = "22", AbteilungId = 1, FunktionId = 6, NiederlassungId = 3, Geburtsdatum = new DateOnly(1970, 02, 06) },
        //        new Mitarbeiter { MitarbeiterId = 3, Prsnr = "1003", Nachname = "Schiefner", Vorname = "Emi", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2010, 10, 01), Extern = true, Email = "eschiefner@projektdb.de", Durchwahl = "21", AbteilungId = 1, FunktionId = 6, NiederlassungId = 3, Geburtsdatum = new DateOnly(1980, 05, 14) },
        //        new Mitarbeiter { MitarbeiterId = 4, Prsnr = "1004", Nachname = "Geist", Vorname = "Ottmar", Geschlecht = EGeschlecht.m, DatumEintritt = new DateOnly(2010, 10, 15), Extern = true, Email = "ogeist@projektdb.de", Durchwahl = "4567", AbteilungId = 2, FunktionId = 6, NiederlassungId = 2, Geburtsdatum = new DateOnly(1979, 05, 13) },
        //        new Mitarbeiter { MitarbeiterId = 5, Prsnr = "1005", Nachname = "Wendisch", Vorname = "Horst", Geschlecht = EGeschlecht.m, DatumEintritt = new DateOnly(2006, 01, 02), Extern = true, Email = "hwendisch@projektdb.de", Durchwahl = "123", AbteilungId = 2, FunktionId = 6, NiederlassungId = 1, Geburtsdatum = new DateOnly(1981, 05, 14) },
        //        new Mitarbeiter { MitarbeiterId = 6, Prsnr = "1006", Nachname = "Koritz", Vorname = "Gundula", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2006, 01, 03), Extern = true, Email = "gkoritz@projektdb.de", Durchwahl = "13", AbteilungId = 2, FunktionId = 5, NiederlassungId = 3, Geburtsdatum = new DateOnly(1985, 06, 16) },
        //        new Mitarbeiter { MitarbeiterId = 7, Prsnr = "1007", Nachname = "Lorenz", Vorname = "Kathrin", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2006, 01, 17), Extern = true, Email = "klorenz@projektdb.de", Durchwahl = "35", AbteilungId = 3, FunktionId = 2, NiederlassungId = 3, Geburtsdatum = new DateOnly(1998, 10, 26) },
        //        new Mitarbeiter { MitarbeiterId = 8, Prsnr = "1008", Nachname = "Mühle", Vorname = "Andreas", Geschlecht = EGeschlecht.m, DatumEintritt = new DateOnly(2006, 01, 18), Extern = true, Email = "amuehle@projektdb.de", Durchwahl = "36", AbteilungId = 3, FunktionId = 6, NiederlassungId = 3, Geburtsdatum = new DateOnly(1971, 03, 08) },
        //        new Mitarbeiter { MitarbeiterId = 9, Prsnr = "1009", Nachname = "Arendt", Vorname = "Sibylle", Geschlecht = EGeschlecht.w, DatumEintritt = new DateOnly(2006, 01, 01), Extern = true, Email = "sarendt@projektdb.de", Durchwahl = "234", AbteilungId = 4, FunktionId = 2, NiederlassungId = 1, Geburtsdatum = new DateOnly(1986, 07, 18) },
        //        new Mitarbeiter { MitarbeiterId = 10, Prsnr = "1010", Nachname = "Heinrich", Vorname = "Otto", Geschlecht = EGeschlecht.m, DatumEintritt = new DateOnly(2020, 01, 01), Extern = true, Email = "oheinrich@projektdb.de", Durchwahl = "30", AbteilungId = 4, FunktionId = 6, NiederlassungId = 4, Geburtsdatum = new DateOnly(1979, 05, 13) },
