...
namespace EFCTest02.Lib.Models
{
    public class Testdaten_EFC02
    {
        ...
        {
            modelBuilder.Entity<Niederlassung>().HasData(
                new Niederlassung { NiederlassungId = 1, Niederlassungsbezeichnung = "Berlin", Niederlassungsvorwahl = "(030) 65756", AngelegtAm= DateTime.Now, AngelegtVon=Environment.UserName,IstAktiv=true,IstGeloescht=false },
                new Niederlassung { NiederlassungId = 2, Niederlassungsbezeichnung = "Frankfurt", Niederlassungsvorwahl = "(060) 345012", AngelegtAm = DateTime.Now, AngelegtVon = Environment.UserName, IstAktiv = true, IstGeloescht = false },
                new Niederlassung { NiederlassungId = 3, Niederlassungsbezeichnung = "Hamburg", Niederlassungsvorwahl = "(040) 1234", AngelegtAm = DateTime.Now, AngelegtVon = Environment.UserName, IstAktiv = true, IstGeloescht = false },
                new Niederlassung { NiederlassungId = 4, Niederlassungsbezeichnung = "München", Niederlassungsvorwahl = "(089) 54398", AngelegtAm = DateTime.Now, AngelegtVon = Environment.UserName, IstAktiv = true, IstGeloescht = false });
        }
