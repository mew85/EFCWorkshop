...
public partial class EFC04_OwnedDBContext : DbContext
{
    public EFC04_OwnedDBContext()
    {
    }

    public EFC04_OwnedDBContext(DbContextOptions<EFC04_OwnedDBContext> options)
        : base(options)
    {
    }
