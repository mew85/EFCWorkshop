...
{
    /// <inheritdoc />
    public partial class DritteMigrationMitTestdaten : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.RenameColumn(
                ...
                schema: "dbo",
                table: "mitarbeiter",
                newName: "DatumEintritt");

            migrationBuilder.RenameColumn(
                name: "Datumaustritt",
                schema: "dbo",
                table: "mitarbeiter",
                newName: "DatumAustritt");
            ...
            migrationBuilder.InsertData(
                schema: "dbo",
                table: "niederlassung",
                columns: new[] { "NiederlassungId", "Niederlassungsbezeichnung", "Niederlassungsvorwahl" },
                values: new object[,]
                {
                    { 1, "Berlin", "(030) 65756" },
                    { 2, "Frankfurt", "(060) 345012" },
                    { 3, "Hamburg", "(040) 1234" },
                    { 4, "München", "(089) 54398" }
                });
